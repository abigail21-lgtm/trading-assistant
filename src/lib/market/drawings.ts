...
// one-point horizontal line explicitly marked as "support" or "resistance"
// (a single price, spanning the full chart). `time1`/`time2` are whatever
...
// "trend". For a support/resistance line, time2/price2 just mirror
// time1/price1; only price1 is actually used when rendering one.
